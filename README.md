...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/highered-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14593&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/highered-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `highered` can be installed with:

```
conda install highered
```

It is possible to list all of the versions of `highered` available on your platform with:
